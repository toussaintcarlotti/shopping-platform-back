@props(['darkPrefer' => false])
<div id="kt_header" style="" {{ $attributes->merge(['class' => 'header align-items-stretch']) }}>
                        ...
                        <div
                            ...
                            <div class="menu-item px-5">
                                <a href="{{ route('profile.edit') }}"
                                   class="menu-link px-5">{{ __('Mon compte') }}</a>
                            </div>
                            <div class="separator my-2"></div>
                            <div class="menu-item px-5">
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit"
                                            class="menu-link btn px-5 w-100">{{ __('Déconnexion') }}</button>
                                </form>
                            </div>
                        </div>
                    </div>
